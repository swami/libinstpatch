...
{
    g_slist_foreach(paste_handlers, (GFunc)_ipatch_paste_free_handler, NULL);
    g_slist_free(paste_handlers);
}
/* free paste handler data */
static void _ipatch_paste_free_handler(PasteHandler *data, gpointer user_data)
{
